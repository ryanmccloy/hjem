...
import { HOT_CHOCOLATES, MENU_LOADING_COLOUR } from "../../utils/constants";
...
function Chocolate({ itemGap }) {
  ...
  const {
    ...
    queryKey: ["drinks_menu", HOT_CHOCOLATES],
    queryFn: () => fetchDrinksByCategory(HOT_CHOCOLATES),
  });
  ...
  // Error state
  if (error) return <div>Error loading chocolate based drinks</div>;
